...
class CheckoutScreenReschedule extends StatelessWidget {
  const CheckoutScreenReschedule({super.key});
          ...
          child: Consumer<ScheduleProvider>(
            builder: (context, checkout, child) {
              return ElevatedButton(
                onPressed: () async {
                  checkout.servicesProvider.setPaymentType(
                  ...
                  print(
                    'checkout.paymentUrl ${checkout.servicesProvider.paymentUrl}',
                  );
                  if (success && checkout.servicesProvider.paymentUrl != null) {
                    await launchUrl(
                      Uri.parse(checkout.servicesProvider.paymentUrl!),
